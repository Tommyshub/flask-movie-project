...
def review(movie_id):
    ...
    return render_template('review.html', form=form, reviews=list(reviews), user=user, movie_id=movie_id, movie_title=movie_title, movie_overview=movie_overview, poster_path=poster_path)